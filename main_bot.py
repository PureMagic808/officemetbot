#!/usr/bin/env python3
"""
Специальный файл для запуска только Telegram-бота через workflow run_bot.
"""
import os
import sys
import logging
...
logger.info("Запуск бота через main_bot.py")
...
try:
    ...
    from meme_data import MEMES, is_suitable_meme, MEME_SOURCES, BLOCKED_CONTENT_TAGS
    ...
    if __name__ == "__main__":
        logger.info("Запуск бота из main_bot.py")
        main()
