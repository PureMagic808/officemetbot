...
if __name__ == "__main__":
    logger.info("Запуск только Telegram-бота без веб-интерфейса")

    # Получаем токен из переменных окружения и проверяем его наличие
    ...
    try:
        # Импортируем модули для работы с Telegram
        import random
