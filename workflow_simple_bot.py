#!/usr/bin/env python3
"""
Специальный запускающий файл для бота в workflow run_bot.
Это самая простая реализация бота без дополнительных проверок.
"""
import logging
import os
import signal
...
def main():
    ...
    logger.info("=== ПРЯМОЙ ЗАПУСК TELEGRAM БОТА ДЛЯ WORKFLOW ===")
